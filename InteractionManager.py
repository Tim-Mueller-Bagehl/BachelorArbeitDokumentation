...
from RealtimeTTS import TextToAudioStream, engines
...
class InteractionManager:
    ...
    def __init__(self,*,
                 ...
                 language : str = "",
                 memorysystem_similarityIndex : float = None,
        ...
        if memorysystem_similarityIndex is None: memorysystem_similarityIndex = threshold
        ...
        self.ModelGateway = ModelGateway(self.VectorDatabase,
                                                             ...
                                                             similarityIndex=memorysystem_similarityIndex,
    ...
    def start(self):
        ...
        while self.active:
            ...
            ID  = self.SpeakerIdentification.manageVoicerecognition(filepath)
            print("Identification", (datetime.now()-start).total_seconds())
            ...
            if ID:
                ...
                print("Full Respnsetime:",(datetime.now() - start).total_seconds())
            else:
